  ...
  const cards = [
    {
      ...
      content: 'PreLeaseGrid, 12th Floor, Brigade Road, Bengaluru, Karnataka 560001',
    ...
    },
    {
      ...
      title: 'Phone',
      content: '+91 95270 44344',
      buttonText: 'Call Now',
      buttonIcon: <ExternalLink size={16} color="#FFF" />,
      action: () => Linking.openURL('tel:+919527044344'),
    },
    {
      id: 3,
      icon: <Mail size={24} color="#F7C952" />,
      title: 'Email',
      content: 'soham@dolphingroup.net.in',
      buttonText: 'Send Email',
      buttonIcon: <ExternalLink size={16} color="#FFF" />,
      action: () => Linking.openURL('mailto:soham@dolphingroup.net.in'),
    },
    {
      id: 4,
