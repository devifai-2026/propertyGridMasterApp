...
const BasicDetails = forwardRef<any, BasicDetailsProps>(
  ({ onNext, onFormValid, initialData }, ref) => {
    ...
    const [formData, setFormData] = useState({
      ...
      carpetArea: initialData?.carpetArea != null ? String(initialData.carpetArea) : '',
      carpetAreaUnit: initialData?.carpetAreaUnit || 'sqft',
      lastRefurbished: initialData?.lastRefurbished || '',
      ownership: initialData?.ownership || '',
      fourWheelerParkings: initialData?.fourWheelerParkings != null ? String(initialData.fourWheelerParkings) : '',
      twoWheelerParkings: initialData?.twoWheelerParkings != null ? String(initialData.twoWheelerParkings) : '',
      powerBackup: initialData?.powerBackup || '',
      numLifts: initialData?.numLifts != null ? String(initialData.numLifts) : '',
