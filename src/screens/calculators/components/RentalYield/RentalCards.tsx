      ...
      <View style={styles.grid}>
        ...
        <View
          style={[
            ...
            styles.redCard,
            { width: cardWidth },
            // !isDesktop && { height: squareSize }, // Removed fixed height for full width cards
          ]}
        >
          <View style={styles.flexGrow}>
            <Text style={styles.title}>Gross Rental Yield</Text>
            <Text style={styles.redValue}>13.33%</Text>
        ...
        <View
          style={[
            ...
            styles.blueCard,
            { width: cardWidth },
            // !isDesktop && { height: squareSize },
          ]}
        >
          <View style={styles.flexGrow}>
            <Text style={styles.title}>Net Rental Yield</Text>
            <Text style={styles.blueValue}>12.11%</Text>
        ...
        >
          <View style={styles.flexGrow}>
            ...
            <Text style={styles.greenValue}>₹5.35 Lakhs</Text>
        ...
        >
          <View style={styles.flexGrow}>
            ...
            <Text style={styles.yellowValue}>9.1 years</Text>
